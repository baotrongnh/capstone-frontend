    ...
    return (
        <Card className="border-slate-200 bg-white" title={t('additionalInfo')}>
            <Descriptions bordered column={1} size="middle">
                ...
                <Descriptions.Item label={t('bedrooms')}>{toDisplayText(apartment?.numberOfBedrooms)}</Descriptions.Item>
                <Descriptions.Item label={t('bathrooms')}>{toDisplayText(apartment?.numberOfBathrooms)}</Descriptions.Item>
                ...
                <Descriptions.Item label={t('roomsCount')}>{cooperationContracts.length}</Descriptions.Item>
                <Descriptions.Item label={t('iotDevicesCount')}>{apartment?.images?.length ?? 0}</Descriptions.Item>
