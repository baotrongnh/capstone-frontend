...
export const useFullAddress = (street: string | undefined, provinceCode: number | undefined, wardCode: number | undefined) => {
     const dataWard = useWard(wardCode)
     const dataProvince = useProvince(dataWard.data?.province_code ?? provinceCode)
